...
main(int argc, char* argv[])
{
    ...
    if (data.convert == nullptr)
    {
        g_printerr("Convert element could not be created. \n");
        err_detected = true;
    }
    ...
    gboolean retval = gst_element_link_many(data.convert, data.resample, data.sink, NULL);
    if (retval == FALSE)
    {
